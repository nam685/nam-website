...
### Listens
A private listening dashboard (admin-only) that syncs with YouTube Music via Google OAuth. Shows recently played tracks, listening stats, top tracks, and daily listening patterns.
