...
function ContributionGraph({ calendar }: { calendar: ContributionCalendar | null }) {
  if (!calendar) {
    return (
      <div style={{ textAlign: "center", color: "#333", fontSize: "0.75rem" }}>
...
export default function CodesPage() {
  ...
  useEffect(() => {
    fetch("/api/github/contributions/")
      ...
      .then((data) => {
        if (data?.contributions) setCalendar(data.contributions);
      })
      .catch(() => {});
  }, []);
