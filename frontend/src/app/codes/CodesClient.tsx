...
const PROJECTS: CodeProject[] = [
  ...
  },
  {
    title: "chess-discord",
    slug: "chess-discord",
    description: "Discord bot for chess accounts.",
    tags: ["python", "discord", "lichess"],
    status: "active",
    github_url: "https://github.com/nam685/chess-discord",
    live_url: "",
    discord_url: "https://discord.gg/DUVbTSnnF",
  },
];
